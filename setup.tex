...
\newcommand{\er}{Engenharia de Requisitos}
\newcommand{\nomeferramenta}{\textit{ReqFlex}}
\newcommand{\stakeholder}{\textit{Stakeholders}}
\newcommand{\sw}{\textit{software}}
\newcommand{\equipe}{\textbf{Equipe de desenvolvimento:}}
\newcommand{\cliente}{\textbf{Cliente:}}
\newcommand{\CRUD}{cadastramento, remoção, atualização e leitura}
\newcommand{\altaPrioridade}{\textcolor{green}{Alta Prioridade}}
\newcommand{\mediaPrioridade}{\textcolor{blue}{Média Prioridade}}
\newcommand{\baixaPrioridade}{\textcolor{red}{Baixa Prioridade}}
\newcommand{\altoRisco}{\textcolor{red}{Risco Alto}}
\newcommand{\medioRisco}{\textcolor{blue}{Risco Médio}}
\newcommand{\baixoRisco}{\textcolor{green}{Risco Baixo}}
\newcommand{\nenhumRisco}{Nenhum Risco}
...
{%
  ...
  \def\@maketitle{%
    ...
    \begin{flushleft}%
      ...
      {\sffamily \LARGE \@title \par}%
      \vskip 1em%
      {\sffamily \large\lineskip .75em\rafael ~-~ \rafaelmatricula}\\%
      %\vskip 1em%
      \sffamily \@date\\
      \vskip 1em%
